...
type NormalsCardMobileProps = OwnProps;

const NormalsCardMobile = (props: NormalsCardMobileProps) => {
    const { normal, character, admin } = props;
    if(normal){
        return (
            <Card className="normal-card" variant="outlined">
                <CardContent className="normal-details" >
...
export default NormalsCardMobile;